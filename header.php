        ...
        <div class="row">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">		    
					...
					<li><form name="searchForm" method="post" action="busca.php"><input type="text"  name="busca" style="color:black" placeholder="Pesquisar"/> <input type="submit" style="color:black" value="Buscar"/></form></li>
                </ul>
            </div>
        </div>
    </div>
